...
error_reporting(0);
		...
		do
		{
			...
			if($valorIni > 0)
			{
				if($valorIni < 5)
				{
					$valorDia = '#Principal #d'.$i.'{ background-color:#F5F5DC ;}'.$valorDia;
				}
				else
				{
					$valorDia = '#Principal #d'.$i.'{ background-color:#D2B48C ;}'.$valorDia;
				}
			}
			else
			{
				$valorDia = '#Principal #d'.$i.'{ background-color:#DCDCDC ;}'.$valorDia;
			}
