...
<div id="main">
  ...
  <p>Data: 
  <label for="txtData" id="distancia" ></label>
  <input type="text" name="txtData" id="txtData" class="distancia" />
  <label for="txtCopiar"></label>
  </p>
  <p> 
    <input type="submit" name="btnchecar" id="btnchecar" value="Enviar" class="distanciaBtn" />
  </p>
  <p>
  ...
  <p>Horários:
  <select name="cmbHorarios" id="cmbHorarios" class="distancia">
    <?php 
  ...
  <p>Tel: 
    <label>
      <input type="text" name="txtTel" id="txtTel" class="distancia2" />
    </label>
    <br />
  </p>
  <p>CEP :
    <input name="txtCEP" type="text"  class="distancia1"/>
</p>
  <p>
    Rua :
    <input name="txtRua" type="text"  class="distancia1"/>
  </p>
  <p>
    Numero:
  ...
  <p>
    Bairro: 
    <input name="txtBairro" type="text" class="distancia3" />
  </p>
  <p>
    Cidade: 
    <input name="txtCidade" type="text"  class="distancia4"/>
  </p>
  <p>
    Estado: 
    <input name="txtEstado" type="text"  class="distancia4"/>
  </p>
  <p>
    <input type="submit" name="btnOk" id="btnOk" value="Cadastrar"  class="distancia"/>
  </p>
  <p>&nbsp;</p>
  <p>&nbsp;</p>
</form>
